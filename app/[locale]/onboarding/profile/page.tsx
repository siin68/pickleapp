...
import { Button, Input, Textarea, Avatar, AvatarImage, AvatarFallback } from '@/components/ui';
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-xl shadow-purple-50/50 p-8 md:p-10 border border-white">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex flex-col items-center">
              <div className="relative group cursor-pointer">
                ...
                <Avatar className="w-32 h-32 border-4 border-white shadow-lg relative z-10">
                  ...
                  <AvatarFallback className="bg-gradient-to-br from-gray-50 to-gray-100 text-gray-400 text-4xl font-bold">
                    {formData.name.charAt(0) || <UserIcon className="w-10 h-10 opacity-50" />}
                  </AvatarFallback>
                </Avatar>
              ...
              <p className="mt-4 text-sm font-medium text-gray-400">Tap to upload photo</p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                 <label className="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">{t('bio')}</label>
                 <Textarea

...
export default function DashboardHome() {
  ...
  const openCount = MOCK_EVENTS.filter(e => e.status === 'open').length;
           ...
           <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex items-center gap-6 w-full">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-pink-100 text-lg font-medium max-w-lg leading-relaxed">
                    Ready to find your next adventure? There are <span className="font-bold text-white bg-white/20 px-2 py-0.5 rounded-full">{openCount}</span> live invites waiting for you.
                  </p>
                </div>
             </div>
             ...
             <div className="hidden lg:flex gap-4">
               <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 text-center min-w-[100px]">
                 ...
                 <div className="text-xs font-bold uppercase tracking-wider text-pink-100">Active</div>
               </div>
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 text-center min-w-[100px]">
                 <div className="text-3xl font-bold">0</div>
                 <div className="text-xs font-bold uppercase tracking-wider text-pink-100">Matches</div>
               </div>
             </div>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <CardContent className="p-8 flex flex-col items-center text-center gap-4 relative z-10">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-800 mb-1">{tNav('openInvites')}</h3>
                <p className="text-sm text-gray-500 font-medium">Browse public meetups</p>
              </div>
            </CardContent>
          </Card>
          ...
          >
            ...
            <CardContent className="p-8 flex flex-col items-center text-center gap-4 relative z-10">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-800 mb-1">{tNav('hobbyMatch')}</h3>
                 <p className="text-sm text-gray-500 font-medium">Find interest twins</p>
              </div>
            </CardContent>
          </Card>
          ...
          >
            ...
            <CardContent className="p-8 flex flex-col items-center text-center gap-4 relative z-10">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-1">{tNav('createInvite')}</h3>
                 <p className="text-sm text-gray-300 font-medium">Host your own vibe</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between px-2">
            ...
            <Button 
              ...
              onClick={() => router.push('/dashboard/open-invites')}
            >
              See All <ArrowRightIcon className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
            </Button>
          </div>
                 ...
                 >
                   <div className="h-40 bg-gradient-to-br from-indigo-400 via-purple-400 to-pink-400 relative overflow-hidden shrink-0">
                      ...
                      <div className="absolute bottom-4 left-4 text-white flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-[10px] font-bold uppercase tracking-widest text-indigo-100">{hobby?.name}</p>
                          <h3 className="font-bold text-lg leading-tight text-white drop-shadow-sm">{event.title}</h3>
                        </div>
                      </div>
                     ...
                     <div className="space-y-4">
                       <div className="flex items-center gap-3 text-gray-600 bg-gray-50 rounded-xl p-3">
                         ...
                         <div className="text-sm">
                           <span className="block font-bold text-gray-800">{event.date}</span>
          ...
          {upcomingEvents.length === 0 && (
            <div className="rounded-[2rem] border-2 border-dashed border-gray-200 bg-white/50 p-12 text-center">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gray-100 mb-6 text-4xl">
               ...
               <h3 className="text-xl font-bold text-gray-800 mb-2">It quiet... too quiet.</h3>
               <p className="text-gray-500 mb-6">No public events right now. Be the trailblazer!</p>
               <Button onClick={() => router.push('/dashboard/create-invite')} className="rounded-full bg-gray-900 text-white px-8">
                 Create First Event
               </Button>
            </div>
          )}
